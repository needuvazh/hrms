# Masters API Documentation

This folder contains backend API contracts for all Phase 1 masters.

Implementation location: `hrms-modules/hrms-master-data`.

- `step1-saas-masters-api.md` - Tenant/SaaS platform masters
