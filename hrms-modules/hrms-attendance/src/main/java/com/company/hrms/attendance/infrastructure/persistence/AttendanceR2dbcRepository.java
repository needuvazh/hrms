package com.company.hrms.attendance.infrastructure.persistence;
...
public class AttendanceR2dbcRepository implements AttendanceRepository {
    ...
    private Shift mapShift(
        ...
        return new Shift(id, tenantId, shiftCode, shiftName, startTime, endTime, Boolean.TRUE.equals(active), createdAt, updatedAt);
    }

    private ShiftAssignment mapShiftAssignment(
            UUID id,
            String tenantId,
            UUID employeeId,
            UUID shiftId,
        ...
        return new ShiftAssignment(id, tenantId, employeeId, shiftId, effectiveFrom, effectiveTo, Boolean.TRUE.equals(active), createdAt, updatedAt);
    }

    private AttendanceRecord mapAttendanceRecord(
            UUID id,
            String tenantId,
            UUID employeeId,
    ...
    private PunchEvent mapPunchEvent(
            UUID id,
            String tenantId,
            UUID employeeId,
            UUID shiftId,
        ...
        return new PunchEvent(id, tenantId, employeeId, shiftId, attendanceRecordId, PunchType.valueOf(punchType), eventTime, source, createdAt);
    }
