...
@Tag(name = "Employee Onboarding", description = "Cross-module employee onboarding orchestration APIs")
public class EmployeeOnboardingController {
    ...
    public Mono<EmployeeOnboardingView> onboardEmployee(@Valid @RequestBody EmployeeOnboardingRequest request) {
        return employeeOnboardingApi.onboardEmployee(new EmployeeOnboardingCommand(
                ...
                request.jobTitle(),
                request.actor(),
                request.userAccountSetup() == null ? null : new EmployeeOnboardingCommand.UserAccountSetup(
                ...
                request.leaveBalanceSetup() == null ? null : new EmployeeOnboardingCommand.LeaveBalanceSetup(
                ...
                request.attendanceSetup() == null ? null : new EmployeeOnboardingCommand.AttendanceSetup(
                ...
                request.documents() == null ? List.of() : request.documents().stream()
                        .map(document -> new EmployeeOnboardingCommand.DocumentSetup(
    ...
    public record UserAccountSetupRequest(
            ...
            String rawPassword,
            @Schema(description = "Role code to assign to the account", example = "EMPLOYEE")
            String roleCode
    ) {
    }
    ...
    public record AttendanceSetupRequest(
            ...
            UUID shiftId,
            @Schema(description = "Shift assignment start date", example = "2026-01-01")
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate effectiveFrom,
            @Schema(description = "Shift assignment end date, null means open-ended", example = "2026-12-31")
