...
public class EmployeeR2dbcRepository implements EmployeeRepository {
    ...
    private EmployeeDto mapEmployee(
            UUID id,
            String tenantId,
            String employeeCode,
            UUID personId,
        ...
        return new EmployeeDto(id, tenantId, employeeCode, personId, firstName, lastName, email, departmentCode, jobTitle, createdAt, updatedAt);
    }
