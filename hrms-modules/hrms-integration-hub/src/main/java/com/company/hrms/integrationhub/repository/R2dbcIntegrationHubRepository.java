...
public class R2dbcIntegrationHubRepository implements IntegrationHubRepository {
    ...
    private IntegrationDefinitionDto mapDefinition(
            UUID id,
            String tenantId,
        ...
        return new IntegrationDefinitionDto(
                id,
                tenantId,
                integrationKey,
    ...
    private IntegrationEndpointDto mapEndpoint(
            UUID id,
            UUID definitionId,
            String tenantId,
            String endpointKey,
    ...
    private IntegrationExecutionDto mapExecution(
            UUID id,
            String tenantId,
            UUID definitionId,
            UUID endpointId,
