...
public class LeaveR2dbcRepository implements LeaveRepository {
    ...
    private LeaveTypeDto mapLeaveType(
            UUID id,
            String tenantId,
            String leaveCode,
            String leaveName,
        ...
        return new LeaveTypeDto(id, tenantId, leaveCode, leaveName, Boolean.TRUE.equals(paid), annualLimitDays, Boolean.TRUE.equals(active), createdAt, updatedAt);
    }

    private LeaveBalanceDto mapLeaveBalance(
            UUID id,
            String tenantId,
            UUID employeeId,
            UUID leaveTypeId,
        ...
        return new LeaveBalanceDto(id, tenantId, employeeId, leaveTypeId, leaveYear, totalDays, usedDays, remainingDays, createdAt, updatedAt);
    }

    private LeaveRequestDto mapLeaveRequest(
            UUID id,
            String tenantId,
            UUID employeeId,
            UUID leaveTypeId,
