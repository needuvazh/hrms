...
import com.company.hrms.masterdata.model.LookupValueDto;
...
public class MasterDataR2dbcRepository implements MasterDataRepository {
    ...
    @Override
    public Flux<LookupValueDto> findByType(String lookupType, String tenantId) {
        return databaseClient.sql("""
                ...
                .map((row, metadata) -> new LookupValueDto(
