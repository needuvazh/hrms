...
public class R2dbcNotificationTemplateRepository implements NotificationTemplateRepository {
    ...
    @Override
    public Mono<NotificationTemplateDto> findActiveTemplate(String tenantId, String templateCode, NotificationChannel channel) {
        return databaseClient.sql("""
                ...
                .map((row, metadata) -> new NotificationTemplateDto(
