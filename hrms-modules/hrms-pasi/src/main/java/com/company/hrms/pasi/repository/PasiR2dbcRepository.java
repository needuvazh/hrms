...
public class PasiR2dbcRepository implements PasiRepository {
    ...
    @Override
    public Flux<PasiEmployeeContributionDto> saveEmployeeContributions(Flux<PasiEmployeeContributionDto> contributions) {
    ...
    private PasiContributionRuleDto mapRule(
            UUID id,
            String tenantId,
            String ruleCode,
            String name,
        ...
        return new PasiContributionRuleDto(
                id,
                tenantId,
                ruleCode,
                name,
    ...
    private PasiPeriodRecordDto mapPeriodRecord(
            UUID id,
            String tenantId,
            UUID payrollRunId,
            String periodCode,
    ...
    private PasiEmployeeContributionDto mapEmployeeContribution(
            UUID id,
            String tenantId,
            UUID periodRecordId,
