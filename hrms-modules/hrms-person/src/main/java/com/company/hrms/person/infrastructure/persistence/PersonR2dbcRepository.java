package com.company.hrms.person.infrastructure.persistence;
...
public class PersonR2dbcRepository implements PersonRepository {
    ...
    @Override
    public Mono<Person> findById(UUID personId, String tenantId) {
    ...
    @Override
    public Flux<Person> search(String searchQuery, int limit, int offset, String tenantId) {
    ...
    private Person mapPerson(
        ...
        return new Person(id, tenantId, personCode, firstName, lastName, email, mobile, countryCode, nationalityCode, createdAt, updatedAt);
    }
