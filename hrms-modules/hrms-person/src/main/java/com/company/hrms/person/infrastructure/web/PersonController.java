package com.company.hrms.person.infrastructure.web;
...
@Tag(name = "Person", description = "Person profile management APIs")
public class PersonController {
    ...
    public Mono<PersonView> createPerson(@Valid @RequestBody CreatePersonRequest request) {
        return personModuleApi.createPerson(new CreatePersonCommand(
                request.personCode(),
                request.firstName(),
                request.lastName(),
                request.email(),
    ...
    public Mono<PersonView> getPerson(
    ...
    public Flux<PersonView> searchPersons(
        ...
        return personModuleApi.searchPersons(new PersonSearchQuery(query, limit, offset));
    }
